...
<html lang="ru-RU">
<head>
<title>Творческий конкурс журналистов Оренбуржья</title>
<meta charset="utf-8">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Творческий конкурс<br>
							 журналистов оренбуржья</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Министерства региональной и информационной политики Оренбургской области
							</p>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							<div class="discord-tx1-mantra darkmode-txt">
								<h2>Подача заявки на участие</h2>
								<div class="landing-con-divider">
								</div>
							</div>
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 ФИО автора (авторов), должность, место работы, тема работы, заголовок работы, аннотацию по конкурсной работе, а также приложить свою конкурсную работу в формате выдержки публикации из СМИ (docx, pdf) или нарезки ролика телепередачи или эфира (avi, mp4).
								</p>
							</div>
							</a>
						</div>
